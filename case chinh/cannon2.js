function Tank2(mapWidth, mapHeight) {
...
Tank2.prototype.draw = function (context) {
    context.beginPath();
...
Tank2.prototype.fire = function(targetX, targetY){
...
Tank2.prototype.rotateCannon = function (targetX, targetY) {
    var dx = targetX - this.cx;
    var dy = targetY - this.cy;
...
Tank2.prototype.resetSpeed = function () {
    this.speedX = 0;
    this.speedY = 0;
}
Tank2.prototype.moveLeft = function () {
    this.speedX = this.power;
}
Tank2.prototype.moveRight = function () {
    this.speedX = -this.power;
}